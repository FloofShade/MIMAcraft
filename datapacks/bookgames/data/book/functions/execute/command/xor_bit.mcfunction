...
execute unless score xnum calc >= temp calc if score number calc >= temp calc run scoreboard players add arg calc 1
...
execute if score temp calc matches 1.. run function book:execute/command/xor_bit