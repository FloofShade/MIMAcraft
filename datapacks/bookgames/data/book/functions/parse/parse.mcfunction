...
execute unless score is_command calc matches 1 run data modify storage bookgames:debug line.last_label set from storage bookgames:mima tech.memloc.score
$execute unless score is_command calc matches 1 run data modify storage bookgames:debug line.label set value "$(entry)"
