execute store result storage bookgames:challenge memloc.rng int 1 run random value -50..50
...
execute store result storage bookgames:challenge memloc.rng int 1 run random value 2..10
