...
summon text_display 16 4 17 {Tags:["challenge_menu","challenge_name"],text:'{"text":"Challenge: The Simplest Program","color":"green"}',background:1677721600,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,1f,0f,0f],translation:[0f,0.1f,-1f],scale:[1f,1f,1f]}}
